#!/bin/ksh
# Program name: ez_nim.sh
# Purpose: NIM master operation menu
...
#Update the below item for your environment
...
select create_nim_menu in "create NIM client" "create mksysb" "create spot" "create BOS" "create NIM network" "Return to Main Menu"
do
